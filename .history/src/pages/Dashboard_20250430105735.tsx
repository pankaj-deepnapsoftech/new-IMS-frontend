...
const dynamicColor = (index: number) => {
  ...
  return (
    <div>
      <div className=" scrollbar flex flex-col  md:items-center md:justify-between gap-6 p-8 backdrop-blur-lg bg-gradient-to-r from-[#4f5f79] to-[#6987b1] rounded-xl shadow-sm">
