...
<div className="flex flex-col  md:justify-between md:items-center gap-y-2">
  ...
  <div className="flex flex-row  gap-2 w-full md:w-auto mt-2 md:mt-0">
    ...
    <div className="relative flex-1 min-w-[150px]">
      ...
      <input
        className="pl-10 pr-4 py-2 w-full text-sm rounded-[5px] border-b bg-[#ffffff3b] placeholder:text-gray-300 shadow-sm focus:outline-none placeholder:text-gray-500"
