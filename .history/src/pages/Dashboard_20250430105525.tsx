...
const dynamicColor = (index: number) => {
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-8 backdrop-blur-lg bg-gradient-to-r from-[#4f5f7971] to-[#6987b1] rounded-xl shadow-sm">
