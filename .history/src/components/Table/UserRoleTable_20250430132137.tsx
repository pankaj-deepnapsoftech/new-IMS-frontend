                      ...
                      {row.cells.map((cell) => (
                        ...
                        >
                          {cell.column.id === "createdAt" || cell.column.id === "updatedAt"
                            ...
                            : cell.column.id === "role" ? (
                              <Badge  color="gray.00" fontSize="14px" textTransform="capitalize" fontWeight="600" bg="transparent" >
                                {row.original.role}
                              </Badge>
                            ) : (
                              cell.render("Cell")
                        ...
                        <div className="flex items-center gap-3">
                          {openRoleDetailsDrawerHandler && (
                            <Tooltip label="View Details">
                              <span>
                                <MdOutlineVisibility
                                  className="cursor-pointer text-gray-00 hover:text-blue-500 transition-transform hover:scale-110"
                                  size={18}
                                  onClick={() =>
                          ...
                          {openUpdateRoleDrawerHandler && (
                            <Tooltip label="Edit Role">
                              <span>
                                <MdEdit
                                  className="cursor-pointer text-gray-00 hover:text-red-500 transition-transform hover:scale-110"
                                  size={18}
                                  onClick={() =>
                          ...
                          {deleteRoleHandler && (
                            <Tooltip label="Delete Role">
                              <span>
                                <MdDeleteOutline
                                  className="cursor-pointer text-gray-00 hover:text-red-600 transition-transform hover:scale-110"
                                  size={18}
                                  onClick={() =>
