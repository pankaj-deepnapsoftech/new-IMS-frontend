  ...
  return (
    <div>
      <FormControl isRequired>
        <FormLabel fontWeight="bold" color="white">Raw Materials</FormLabel>
        {inputs.map((input, ind) => (
          ...
          >
            ...
            <FormControl isRequired>
              <FormLabel fontWeight="bold" color="">UOM</FormLabel>
              <Input
                isDisabled={true}
                border="1px"
                borderColor="#a9a9a9"
            ...
            <FormControl>
              <FormLabel fontWeight="bold" color="">Assembly Phase</FormLabel>
              <Select
                className="rounded mt-2 border border-[#a9a9a9]"
            ...
            <FormControl isRequired>
              <FormLabel fontWeight="bold" color="">Unit Cost</FormLabel>
              <Input
                isDisabled={true}
                border="1px"
                borderColor="#a9a9a9"
            ...
            <FormControl>
              <FormLabel fontWeight="bold" color="">Total Part Cost</FormLabel>
              <input
                disabled={true}
                onChange={(e) => {
                  onChangeHandler(e.target.name, e.target.value, ind);
