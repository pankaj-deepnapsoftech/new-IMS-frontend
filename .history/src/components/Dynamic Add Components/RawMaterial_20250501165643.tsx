  ...
  return (
    <div>
      <FormControl isRequired>
        <FormLabel fontWeight="bold" color="white" fontSize="">Raw Materials</FormLabel>
          ...
          >
            ...
            <FormControl>
              ...
              <input
                ...
                className="rounded disabled:bg-transparent px-2 py-[6px] w-[300px] border-[1px] border-[#a9a9a9] disabled:cursor-not-allowed "
              ></input>
            </FormControl>
          </div>
        ))}
