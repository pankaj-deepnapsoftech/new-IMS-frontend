            ...
            <div >
              ...
              <FormControl className="mt-3 mb-5" isRequired>
                ...
                <input  
                  ...
                  className="rounded px-2 py-[6px] w-[267px] text-gray-200 border-[1px] border-[#a9a9a9] disabled:cursor-not-allowed disabled:bg-transparent"
                />
              </FormControl>
              <FormControl className="mt-3 mb-5" isRequired>
                ...
                <input
                  ...
                  className="rounded px-2 py-[6px] text-gray-200 w-[267px] border-[1px] border-[#a9a9a9] disabled:cursor-not-allowed disabled:bg-transparent"
                />
              </FormControl>
            </div>
