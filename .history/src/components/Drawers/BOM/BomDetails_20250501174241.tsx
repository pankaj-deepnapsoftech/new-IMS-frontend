            ...
            <div className="text-white">
              ...
              {finishedGood && (
                <div className="mt-3 mb-5">
                  ...
                  <ul className="pl-5">
                    <li>
                      <span className="font-semibold text">Item Id</span>:{" "}
                    ...
                    <li>
                      <span className="font-semibold text">UOM</span>:{" "}
                      {finishedGood?.item?.uom}
                    </li>
                    <li>
                      <span className="font-semibold text">Category</span>:{" "}
                    ...
                    <li>
                      <span className="font-semibold text">Cost</span>: ₹{" "}
                      {finishedGood.cost}/-
                    </li>
                    <li>
                      <span className="font-semibold text">Supporting Document</span>
                      :{" "}
