      ...
      >
        ...
        <h2 className="text-xl text-center  font-semi600 py-3 px-4 bg-[#ffffff4f]  rounded-md text-white  mb-6  ">     
          ...
          <form onSubmit={addBomHandler}>
            ...
            <div>
              ...
              <div>
                ...
                <FormControl className="mt-3 mb-5">
                  <FormLabel fontWeight="bold" color>Description</FormLabel>
                  <Input
                    border="1px"
                    borderColor="#a9a9a9"
                    value={description}
                ...
                <FormControl className="mt-3 mb-5" isRequired>
                  <FormLabel fontWeight="bold" color>Quantity</FormLabel>
                  <Input
                    border="1px"
                    borderColor="#a9a9a9"
                    value={quantity}
                ...
                <FormControl className="mt-3 mb-5" isRequired>
                  <FormLabel fontWeight="bold" color>Category</FormLabel>
                  <Input
                    isDisabled={true}
                    border="1px"
                    borderColor="#a9a9a9"
                ...
                <FormControl className="mt-3 mb-5">
                  <FormLabel fontWeight="bold" color>Supporting Doc</FormLabel>
                  <input
                    ref={supportingDoc}
                    type="file"
                ...
                <FormControl className="mt-3 mb-5">
                  <FormLabel fontWeight="bold" color>Comments</FormLabel>
                  <Input
                    border="1px"
                    borderColor="#a9a9a9"
                    value={comments}
                ...
                <FormControl className="mt-3 mb-5" isRequired>
                  <FormLabel fontWeight="bold" color>Cost</FormLabel>
                  <Input
                    isDisabled={true}
                    border="1px"
                    borderColor="#a9a9a9"
            ...
            <div>
              <h2 className="text-lg font-semibold mt-4 mb-2" color>Other Charges</h2>
              <div >
                <FormControl>
                  <FormLabel fontWeight="bold" color>Labour Charges</FormLabel>
                  <Input
                    border="1px"
                    borderColor="#a9a9a9"
                    value={labourCharges}
                ...
                <FormControl>
                  <FormLabel fontWeight="bold" color>Machinery Charges</FormLabel>
                  <Input
                    border="1px"
                    borderColor="#a9a9a9"
                ...
                <FormControl>
                  <FormLabel fontWeight="bold" color>Electricity Charges</FormLabel>
                  <Input
                    border="1px"
                    borderColor="#a9a9a9"
                ...
                <FormControl>
                  <FormLabel fontWeight="bold" color>Other Charges</FormLabel>
                  <Input
                    border="1px"
                    borderColor="#a9a9a9"
                    value={otherCharges}
            ...
            <div>
              <FormControl className="mt-3 mb-5" isRequired>
                <FormLabel fontWeight="bold" color>BOM Name</FormLabel>
                <Input
                  border="1px"
                  borderColor="#a9a9a9"
                  value={bomName}
              ...
              <FormControl className="mt-3 mb-5" isRequired>
                <FormLabel fontWeight="bold" color>Parts Count</FormLabel>
                <input
                  disabled={true}
                  value={partsCount}
                  type="number"
              ...
              <FormControl className="mt-3 mb-5" isRequired>
                <FormLabel fontWeight="bold" color>Total Parts Cost</FormLabel>
                <input
                  disabled={true}
