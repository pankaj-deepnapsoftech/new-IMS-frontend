              ...
              {finishedGood && (
                <div className="mt-3 mb-5">
                  ...
                  <ul className="pl-5">
                    ...
                    <li>
                      <span className="font-semibold text-gray">Item Name</span>:{" "}
                      {finishedGood?.item?.name}
                    </li>
                    <li>
                      <span className="font-semibold text-gray">Quantity</span>:{" "}
                      {finishedGood.quantity}
                    </li>
                    <li>
                      <span className="font-semibold text-gray">UOM</span>:{" "}
                      {finishedGood?.item?.uom}
                    </li>
                    <li>
                      <span className="font-semibold text-gray">Category</span>:{" "}
                    ...
                    <li>
                      <span className="font-semibold text-gray">Cost</span>: ₹{" "}
                      {finishedGood.cost}/-
                    </li>
                    <li>
                      <span className="font-semibold text-gray">Supporting Document</span>
                      :{" "}
