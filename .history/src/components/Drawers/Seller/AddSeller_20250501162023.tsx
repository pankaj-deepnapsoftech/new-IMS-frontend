        ...
        <h2 className="text-xl text-center  font-semi600 py-3 px-4 bg-[#ffffff4f]  rounded-md text-white  mb-6  ">     
          ...
          <form onSubmit={addSellerHandler}>
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="w">Name</FormLabel>
              <Input
                value={name}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="w">Email</FormLabel>
              <Input
                value={email}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="w">Phone</FormLabel>
              <Input
                value={phone}
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color="w">GST Number</FormLabel>
              <Input
                value={gst}
                className="no-scrollbar"
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="w">Company Name</FormLabel>
              <Input
                className="no-scrollbar"
                value={companyName}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="w">Current Email</FormLabel>
              <Input
                value={companyEmail}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="w">Company Phone</FormLabel>
              <Input
                value={companyPhone}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="w">Address Line 1</FormLabel>
              <Input
                value={addressLine1}
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color="w">Address Line 2</FormLabel>
              <Input
                value={addressLine2}
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color="w">Pincode</FormLabel>
              <Input
                value={pincode}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="w">City</FormLabel>
              <Input
                value={city}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="w">State</FormLabel>
              <Input
                value={state}
