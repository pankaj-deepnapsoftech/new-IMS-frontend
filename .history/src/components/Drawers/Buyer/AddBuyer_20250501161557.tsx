        ...
        <h2 className="text-xl text-center  font-semi600 py-3 px-4 bg-[#ffffff4f]  rounded-md text-white  mb-6  ">     
          ...
          <form onSubmit={addBuyerHandler}>
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Input 
              className="text-gray-"                value={name}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Input 
              className="text-gray-"                value={email}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Input 
              className="text-gray-"                value={phone}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Input 
              className="text-gray-"                className="no-scrollbar"
                value={companyName}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Input 
              className="text-gray-"                value={companyEmail}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Input 
              className="text-gray-"                value={companyPhone}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Input 
              className="text-gray-"                value={addressLine1}
            ...
            <FormControl className="mt-3 mb-5">
              ...
              <Input 
              className="text-gray-"                value={addressLine2}
            ...
            <FormControl className="mt-3 mb-5">
              ...
              <Input 
              className="text-gray-"                value={pincode}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Input 
              className="text-gray-"                value={city}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Input 
              className="text-gray-"                value={state}
