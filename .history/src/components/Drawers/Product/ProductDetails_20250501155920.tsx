          ...
          {!isLoadingProduct && (
            <div>
              <div className="mt-3 mb-5 text-white">
                ...
                <p className="text-gray-gray>{inventoryCategory || 'N/A'}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Product ID</p>
                <p className="text-gray-gray>{id}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Product Name</p>
                <p className="text-gray-gray>{name}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Product Price (Default)</p>
                <p className="text-gray-gray>₹ {price}/-</p>
              </div>
              <div className="mt-3 mb-5 text-white">
              ...
              <div className="mt-3 mb-5 text-white">
                ...
                <p className="text-gray-gray>{distributorPrice
                    ? `₹ ${distributorPrice}/-`
                    : "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Product Category</p>
                <p className="text-gray-gray>{category}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Product Sub Category</p>
                <p className="text-gray-gray>{subCategory || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >UOM (Unit of Measurement)</p>
                <p className="text-gray-gray>{uom}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Current Stock</p>
                < className="text-gray-grayp className="text-gray-gray>{currentStock}</p>
              </div className="text-gray-gray>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Min Stock</p>
                <p className="text-gray-gray>{minStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Max Stock</p>
                <p className="text-gray-gray>{maxStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >HSN</p>
                <p className="text-gray-gray>{hsn || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Store</p>
                <p className="text-gray-gray>{store || "N/A"}</p>
              </div>
            </div>
          )}
        </div>
