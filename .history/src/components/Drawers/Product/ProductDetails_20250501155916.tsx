          ...
          {!isLoadingProduct && (
            <div>
              <div className="mt-3 mb-5 text-white">
                ...
                <p className="text-gray->{inventoryCategory || 'N/A'}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
              ...
              <div className="mt-3 mb-5 text-white">
                ...
                <p className="text-gray->{distributorPrice
                    ? `₹ ${distributorPrice}/-`
                    : "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
              ...
              <div className="mt-3 mb-5 text-white">
                ...
                <p className="text-gray->{subCategory || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >UOM (Unit of Measurement)</p>
                <p className="text-gray->{uom}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Current Stock</p>
                < className="text-gray-p className="text-gray->{currentStock}</p>
              </div className="text-gray->
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Min Stock</p>
                <p className="text-gray->{minStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Max Stock</p>
                <p className="text-gray->{maxStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >HSN</p>
                <p className="text-gray->{hsn || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Store</p>
                <p className="text-gray->{store || "N/A"}</p>
              </div>
            </div>
          )}
        </div>
