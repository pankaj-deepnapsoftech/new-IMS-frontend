        ...
        <h2 className="text-xl text-center  font-semi600 py-3 px-4 bg-[#ffffff4f]  rounded-md text-white  mb-6  ">     
          ...
          <FormLabel fontWeight="bold" color="white">Product Subcategory</FormLabel>
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color="white">HSN Code</FormLabel>
              <Input
                value={hsn}
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color="white">Min Stock Level</FormLabel>
              <Input
                value={minStock}
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color="white">Max Stock Level</FormLabel>
              <Input
                value={maxStock}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Select
                ...
                onChange={(e) => setProductOrService(e)}
              />
            </FormControl>

            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="white">Item Type</FormLabel>
              <Select
                styles={customStyles}
                value={itemType}
