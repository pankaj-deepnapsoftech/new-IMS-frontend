          ...
          {!isLoadingProduct && (
            <div>
              <div className="mt-3 mb-5 text-white">
                ...
                <p className="text-gray-200">{inventoryCategory || 'N/A'}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
              ...
              <div className="mt-3 mb-5 text-white">
                ...
                <p className="text-gray-200">{distributorPrice
                    ? `₹ ${distributorPrice}/-`
                    : "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
              ...
              <div className="mt-3 mb-5 text-white">
                ...
                <p className="text-gray-200">{subCategory || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >UOM (Unit of Measurement)</p>
                <p className="text-gray-200">{uom}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Current Stock</p>
                < className="text-gray-200"p className="text-gray-200">{currentStock}</p>
              </div className="text-gray-200">
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Min Stock</p>
                <p className="text-gray-200">{minStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Max Stock</p>
                <p className="text-gray-200">{maxStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >HSN</p>
                <p className="text-gray-200">{hsn || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Store</p>
                <p className="text-gray-200">{store || "N/A"}</p>
              </div>
            </div>
          )}
        </div>
