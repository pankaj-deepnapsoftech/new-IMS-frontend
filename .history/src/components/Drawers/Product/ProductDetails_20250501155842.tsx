          ...
          {!isLoadingProduct && (
            <div>
              <div className="mt-3 mb-5 text-white">
                ...
                <p class>{inventoryCategory || 'N/A'}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
              ...
              <div className="mt-3 mb-5 text-white">
                ...
                <p class>{subCategory || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
              ...
              <div className="mt-3 mb-5 text-white">
                ...
                < classp class>{currentStock}</p>
              </div class>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Min Stock</p>
                <p class>{minStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Max Stock</p>
                <p class>{maxStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >HSN</p>
                <p class>{hsn || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
