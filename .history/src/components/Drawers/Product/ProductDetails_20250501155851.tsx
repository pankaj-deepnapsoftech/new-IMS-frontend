          ...
          {!isLoadingProduct && (
            <div>
              <div className="mt-3 mb-5 text-white">
                ...
                <p className=">{inventoryCategory || 'N/A'}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
              ...
              <div className="mt-3 mb-5 text-white">
                ...
                <p className=">{subCategory || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
              ...
              <div className="mt-3 mb-5 text-white">
                ...
                < className="p className=">{currentStock}</p>
              </div className=">
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Min Stock</p>
                <p className=">{minStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Max Stock</p>
                <p className=">{maxStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >HSN</p>
                <p className=">{hsn || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5 text-white">
                <p className="font-semibold" >Store</p>
                <p className=">{store || "N/A"}</p>
              </div>
            </div>
          )}
        </div>
