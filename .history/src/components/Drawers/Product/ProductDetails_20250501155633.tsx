          ...
          {!isLoadingProduct && (
            <div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Inventory Category</p>
                <p>{inventoryCategory || 'N/A'}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Product ID</p>
                <p>{id}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Product Name</p>
                <p>{name}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Product Price (Default)</p>
                <p>₹ {price}/-</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Regular Buying Price</p>
                <p>
                  {regularBuyingPrice
                    ? `₹ ${regularBuyingPrice}/-`
                    : "Not Available"}
              ...
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Wholesale Buying Price</p>
                <p>
              ...
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">MRP</p>
                <p>{mrp || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Dealer Price</p>
                <p>{dealerPrice
                    ? `₹ ${dealerPrice}/-`
                    : "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Distributor Price</p>
                <p>{distributorPrice
                    ? `₹ ${distributorPrice}/-`
                    : "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Product Category</p>
                <p>{category}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Product Sub Category</p>
                <p>{subCategory || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">UOM (Unit of Measurement)</p>
                <p>{uom}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Current Stock</p>
                <p>{currentStock}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Min Stock</p>
                <p>{minStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Max Stock</p>
                <p>{maxStock || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">HSN</p>
                <p>{hsn || "Not Available"}</p>
              </div>
              <div className="mt-3 mb-5">
                <p className="font-semibold" color="white">Store</p>
                <p>{store || "N/A"}</p>
              </div>
            </div>
          )}
