        ...
        <h2 className="text-xl text-center  font-semi600 py-3 px-4 bg-[#ffffff4f]  rounded-md text-white  mb-6  ">     
          ...
          <form onSubmit={addProductHandler}><FormControl className="mt-3 mb-5" isRequired>
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color>Product ID</FormLabel>
              <Input
                value={id}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color>Product Name</FormLabel>
              <Input
                value={name}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color>Product Price (Default)</FormLabel>
              <Input
                value={price}
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color>Regular Buying Price</FormLabel>
              <Input
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color>Wholesale Buying Price</FormLabel>
              <Input
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color>MRP</FormLabel>
              <Input
                value={mrp}
                className="no-scrollbar"
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color>Dealer Price</FormLabel>
              <Input
                value={dealerPrice}
                className="no-scrollbar"
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color>Distributor Price</FormLabel>
              <Input
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color>Product Category</FormLabel>
              <Select
              styles={customStyles}
                value={category}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color>UOM (Unit of Measurement)</FormLabel>
              <Select
              styles={customStyles}
                value={uom}
                options={uomOptions}
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color>Product Subcategory</FormLabel>
              <Input
                value={subCategory}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color>Product Type</FormLabel>
              <Select
              styles={customStyles}
                value={itemType}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color>Product/Service</FormLabel>
              <Select
              styles={customStyles}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color>Current Stock</FormLabel>
              <Input
                value={currentStock}
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color>Min Stock</FormLabel>
              <Input
                value={minStock}
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color>Max Stock</FormLabel>
              <Input
                value={maxStock}
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color>HSN</FormLabel>
              <Input
                value={hsn}
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color>Store</FormLabel>
              <Select
              styles={customStyles}
