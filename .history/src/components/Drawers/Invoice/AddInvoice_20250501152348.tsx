        ...
        <h2 className="text-xl text-center  font-semi600 py-3 px-4 bg-[#ffffff4f]  rounded-md text-white  mb-6  ">     
          ...
          <form onSubmit={addInvoiceHandler}>
            ...
            {category && category.value === "sale" && (
              <FormControl className="mt-3 mb-5" isRequired>
                <FormLabel fontWeight="bold" color="">Buyer</FormLabel>
                <Select
                  value={buyer}
            ...
            {category && category.value === "purchase" && (
              <FormControl className="mt-3 mb-5" isRequired>
                <FormLabel fontWeight="bold" color="">Supplier</FormLabel>
                <Select
                  value={supplier}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="">Invoice No.</FormLabel>
              <Input
                value={invoiceNo}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="">Document Date</FormLabel>
              <Input
                value={documentDate}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="">Sales Order Date</FormLabel>
              <Input
            ...
            <FormControl className="mt-3 mb-5">
              <FormLabel fontWeight="bold" color="">Note</FormLabel>
              <textarea
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="">Items</FormLabel>
              <AddItems inputs={inputs} setInputs={setInputs} />
            </FormControl>
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="">Subtotal</FormLabel>
              <Input
                value={subtotal}
                isDisabled={true}
                className="no-scrollbar"
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="">Tax</FormLabel>
              <Select
                required={true}
                value={tax}
                options={taxOptions}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="">Total</FormLabel>
