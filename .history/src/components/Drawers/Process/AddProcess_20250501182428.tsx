         ...
         Add New Production Process
          ...
          <form onSubmit={addProcessHandler}>
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Select styles={cus}  value={itemName} options={itemNameOptions} onChange={(d: any) => setItemName(d)} required />
            </FormControl>
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="white">BOM</FormLabel>
              <Select styles={cus} value={bom} options={bomOptions} onChange={(d: any) => setBom(d)} required />
            </FormControl>
            <FormControl className="mt-3 mb-5" isRequired>
