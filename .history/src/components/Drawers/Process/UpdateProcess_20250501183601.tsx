        ...
        <h2 className="text-xl text-center  font-semi600 py-3 px-4 bg-[#ffffff4f]  rounded-md text-white  mb-6  ">     
          ...
          <form onSubmit={updateProcessHandler}>
            ...
            <div className="mt-4">
              ...
              <div className="">
                <FormControl className="mt-3 mb-5" isRequired>
                  <FormLabel fontWeight="bold" color="">Finished Good</FormLabel>
                  <Select
                    isDisabled
                ...
                <FormControl className="mt-3 mb-5" isRequired>
                  <FormLabel fontWeight="bold" color="">Estimated Quantity</FormLabel>
                  <Input
                    disabled
                    border="1px"
                    borderColor="#a9a9a9"
                ...
                <FormControl className="mt-3 mb-5" isRequired>
                  <FormLabel fontWeight="bold" color="">Produced Quantity</FormLabel>
                  <Input
                    border="1px"
                    borderColor="#a9a9a9"
