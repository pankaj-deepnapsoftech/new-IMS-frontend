         ...
         Add New Production Process
          ...
          <form onSubmit={addProcessHandler}>
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Select styles={} value={fgStore} options={fgStoreOptions} onChange={(d: any) => setFgStore(d)} required />
            </FormControl>
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="white">RM Store</FormLabel>
              <Select styles={} value={rmStore} options={rmStoreOptions} onChange={(d: any) => setRmStore(d)} required />
            </FormControl>
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color="white">Scrap Store</FormLabel>
              <Select styles={} value={scrapStore} options={scrapStoreOptions} onChange={(d: any) => setScrapStore(d)} required />
            </FormControl>
            <Button
              isLoading={isAdding}
              type="submit"
