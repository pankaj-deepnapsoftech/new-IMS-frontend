         ...
         Add New Production Process
          ...
          <form onSubmit={addProcessHandler}>
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color=>Item Id</FormLabel>
              <Input
                value={itemId}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color=>Item Name</FormLabel>
              <Select value={itemName} options={itemNameOptions} onChange={(d: any) => setItemName(d)} required />
            </FormControl>
            <FormControl className="mt-3 mb-5" isRequired>
              <FormLabel fontWeight="bold" color=>BOM</FormLabel>
