  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const backendUrl = process.env.REACT_APP_BACKEND_URL || 'http://localhost:8085/api/';
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">
                  {dashboardData?.proformaInvoice?.total || 0}
                </p>
                <p className={`text-sm ${getChangeColor(dashboardData?.proformaInvoice?.total || 0, dashboardData?.proformaInvoice?.lastMonth || 0)}`}>
                  {getChangeText(dashboardData?.proformaInvoice?.total || 0, dashboardData?.proformaInvoice?.lastMonth || 0)}
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">
                  {dashboardData?.taxInvoice?.total || 0}
                </p>
                <p className={`text-sm ${getChangeColor(dashboardData?.taxInvoice?.total || 0, dashboardData?.taxInvoice?.lastMonth || 0)}`}>
                  {getChangeText(dashboardData?.taxInvoice?.total || 0, dashboardData?.taxInvoice?.lastMonth || 0)}
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-sm ${getChangeColor(dashboardData?.payments?.total || 0, dashboardData?.payments?.lastMonth || 0)}`}>
                  {getChangeText(dashboardData?.payments?.total || 0, dashboardData?.payments?.lastMonth || 0)}
                </p>
              </div>
