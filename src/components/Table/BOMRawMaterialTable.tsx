      ...
      <div>
        ...
        {!isLoadingProducts && products.length > 0 && (
          <div>
            ...
            <TableContainer maxHeight="600px" overflowY="auto" className="bg-[#14243452]  rounded-md">
              <Table variant="simple" {...getTableProps()} bg="#14243452" border="none">
                ...
                <Tbody {...getTableBodyProps()} >
                  {page.map((row: any,index) => {
                    ...
                    return (
                      <Tr
                        className="relative  hover:cursor-pointer text-gray-300 text-[14px] font-[600] border-none"
                        {...row.getRowProps()}
                        bg={dynamicBg(index)}
                        _hover={{
                          bg: "#ffffff78",
